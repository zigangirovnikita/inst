(function liveAuditScreen() {
  ...
  const defaultAuditPoints = [
    'Контент-план на 7 дней на основе успешных Reels прямых конкурентов.',
    'Воронку по этапам и инструментам именно под ваш бизнес.',
    'Офферы для каждого этапа и инструмента воронки.',
    'Способ отделять целевых людей от нецелевых, чтобы не сливать энергию на тех, кто не купит.',
    'Логику продуктов, трипваера и оплаты там, где это нужно для запуска.',
  ];
  ...
  function auditPoints() {
    ...
    return selectedRoute ? [
      'Контент-план на 7 дней на основе успешных Reels прямых конкурентов.',
      'Офферы и скрипты под этапы выбранной воронки: ' + selectedRoute + '.',
      'План запуска выбранного варианта без лишних технических шагов.',
    ] : defaultAuditPoints;
  }
